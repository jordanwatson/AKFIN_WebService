...
Probably sufficient below to just make a plot of shark v. SST instead of the whole prediction stuff.
But I'm happy with whatever really!
...
mursst %>% 
  mutate(shark=ifelse(is.na(OBS_SPECIE_CODE),0,1)) %>% 
  ggplot(aes(shark,SST)) + 
  geom_point()
```
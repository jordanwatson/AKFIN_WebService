...
**R Code Input - 1** Web service query of sea surface temperature for NMFS Areas 640
```{r, message=FALSE}
#Install packages
...
**R Code Input - 2** Web service query of sea surface temperature for NMFS Areas 640 and 650, averaged for June, July, and August 
```{r, message=FALSE}
httr::content(
...
**R Code Input - 3** The full time series yields more than 13,000 rows of data per area (i.e., daily data from 1985-01-01 to present). 
```{r}
...
**R Code Input - 4** SST in NMFS area 640 in 1987.
```{r, message=FALSE}
httr::content(

...
ggplot(data = mhw_clim, aes(x = t)) +
  geom_flame(aes(y = temp, y2 = thresh, fill = "all"),
             show.legend = T) +
  geom_flame(data = mhw_clim, aes(y = temp, y2 = thresh, fill = "top"),  
             show.legend = T) +
...
CRW SST query within SQL Developer. Several columns reveal ‘NA’ because the particular latitude - longitude coordinates shown do not fall within any spatial strata represented by those columns.
